...
final kTranslationsMap = <Map<String, Map<String, String>>>[
  ...
  // MyLeaveRequestsPage
  {
    ...
    'rk5z12oa': {
      ...
      'en': 'Reason for withdrawing',
      'km': 'មូលហេតុនៃការដកខ្លួនចេញ',
    },
    'gci0g4ye': {
      'th': 'Optional — your approver will see this',
      'en': 'Optional — your approver will see this',
      'km': 'ជាជម្រើស — អ្នកអនុម័តរបស់អ្នកនឹងឃើញវា',
    },
    '1kib7r88': {
      'th': 'Keep it',
      'en': 'Keep it',
  ...
  // LeaveRequestFormPage
  {
    ...
    's8xdho89': {
      'th': 'Days requested',
      'en': 'Days requested',
      'km': 'ចំនួនថ្ងៃដែលបានស្នើសុំ',
    },
    'wzpwqlf1': {
      'th': 'Contact phone',
      'en': 'Contact phone',
      'km': 'ទូរស័ព្ទទំនាក់ទំនង',
    },
    '00al5pgk': {
      'th': 'Contact phone',
      'en': 'Contact phone',
    ...
    'a7crtsul': {
      ...
      'en': 'Where your approver can reach you',
      'km': 'កន្លែងដែលអ្នកអនុម័តរបស់អ្នកអាចទាក់ទងអ្នកបាន',
    },
    '4yq1ld8z': {
      'th': 'Reason',
      'en': 'Reason',
    ...
    'sbchzowl': {
      ...
      'en': 'Tell your approver why you need this leave',
      'km':
          'ប្រាប់អ្នកអនុម័តរបស់អ្នកថាហេតុអ្វីបានជាអ្នកត្រូវការការឈប់សម្រាកនេះ',
    },
    'nrtrvmcp': {
      'th': 'Attachment',
      'en': 'Attachment',
    ...
    'hjwbmlq8': {
      ...
      'en': 'Attach a supporting document (coming soon)',
      'km': 'ភ្ជាប់ឯកសារគាំទ្រ (ឆាប់ៗនេះ)',
    },
    '6ojw4m6k': {
      'th': 'Submit request',
      'en': 'Submit request',
  ...
  // LeaveBalancePage
  {
    ...
    'vpwoccez': {
      ...
      'en': 'Pick a leave type to start a request.',
      'km': 'ជ្រើសរើសប្រភេទនៃការឈប់សម្រាកដើម្បីចាប់ផ្តើមសំណើ។',
    },
  },
  // LeaveApprovalQueuePage
  {
    ...
    'ygjo649a': {
      ...
      'en': 'Note to the employee',
      'km': 'កំណត់ចំណាំដល់បុគ្គលិក',
    },
    '4j12v1s7': {
      'th': 'Optional — explain your decision',
      'en': 'Optional — explain your decision',
      'km': 'ជាជម្រើស — ពន្យល់ពីការសម្រេចចិត្តរបស់អ្នក',
    },
    'nm435tbk': {
      'th': 'Cancel',
      'en': 'Cancel',
  ...
  // LeaveHubPage
  {
    'yiy4ybvn': {
      'th': 'Employee Leave',
      'en': 'Employee Leave',
      'km': 'ការឈប់សម្រាករបស់បុគ្គលិក',
    },
    's23ozp1o': {
      'th': 'My leave',
      'en': 'My leave',
      'km': 'ការឈប់សម្រាករបស់ខ្ញុំ',
    },
    'vp67j649': {
      'th': 'Leave balances',
      'en': 'Leave balances',
    ...
    '3lhu7gvp': {
      ...
      'en': 'Entitlement, days used and days remaining',
      'km': 'សិទ្ធិទទួលបាន ចំនួនថ្ងៃប្រើប្រាស់ និងចំនួនថ្ងៃដែលនៅសល់',
    },
    'qn13kwxc': {
      'th': 'My requests',
      'en': 'My requests',
    ...
    '5hcm1kps': {
      ...
      'en': 'Track requests you have submitted',
      'km': 'តាមដានសំណើដែលអ្នកបានដាក់ស្នើ',
    },
    'wz00wys0': {
      'th': 'Approvals',
      'en': 'Approvals',
    ...
    '7wkxk30s': {
      ...
      'en': 'Approve or reject your team\'s requests',
      'km': 'យល់ព្រម ឬបដិសេធសំណើរបស់ក្រុមអ្នក',
    },
    '086fru62': {
      'th': 'Decision history',
      'en': 'Decision history',
    ...
    '9mljsyye': {
      ...
      'en': 'Requests you have already decided',
      'km': 'សំណើដែលអ្នកបានសម្រេចចិត្តរួចហើយ',
    },
  },
  // dropdownComponent
  {
