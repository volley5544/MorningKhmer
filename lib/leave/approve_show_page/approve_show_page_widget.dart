                    ...
                    children: [
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: FlutterFlowDropDown<String>(
                            ...
                            options: [
                              FFLocalizations.of(context).getText(
                                'ymzm1fih' /* previous year */,
                              ),
                              FFLocalizations.of(context).getText(
                                '68vjxl98' /* current year */,
                              ),
                              FFLocalizations.of(context).getText(
                                'jdk5a2v5' /* next year */,
                              )
                            ...
                            hintText: FFLocalizations.of(context).getText(
                              '1lpsqcjf' /* Please select the month you wa... */,
                            ),
                            icon: FaIcon(
                      ...
                      if (true)
                        FlutterFlowDropDown<String>(
                          ...
                          hintText: FFLocalizations.of(context).getText(
                            '6z72qpuf' /* Please select the month you wa... */,
                          ),
                          icon: FaIcon(
                            FontAwesomeIcons.solidCalendarAlt,
                            size: 15.0,
                      ...
                      Expanded(
                        child: TabBarView(
                          ...
                          children: [
                            Builder(
                              builder: (context) {
                                final approveList = List.generate(
                            ...
                            Builder(
                              builder: (context) {
                                final notApproveList = List.generate(
                                    random_data.randomInteger(5, 5),
                                    (index) => random_data.randomString(
                                          0,
                                          0,
                                ...
                                return ListView.builder(
                                  ...
                                  itemBuilder: (context, notApproveListIndex) {
                                                          ...
                                                          children: [
                                                            SelectionArea(
                                                              ...
                                                              FFLocalizations.of(
                                                                      context)
                                                                  .getText(
                                                                '784bd1td' /* [11/11/2565-12/11/2565] */,
                                                              ),
                                                              style: FlutterFlowTheme
                                                                      .of(context)
                                                                  .bodyMedium
                            ...
                            Builder(
                              builder: (context) {
                                final cancelList = List.generate(
                                    random_data.randomInteger(5, 5),
                                    (index) => random_data.randomString(
                                          0,
                                          0,
                                                          ...
                                                          children: [
                                                            SelectionArea(
                                                              ...
                                                              FFLocalizations.of(
                                                                      context)
                                                                  .getText(
                                                                '3f3r2ksr' /* [11/11/2565-12/11/2565] */,
                                                              ),
                                                              style: FlutterFlowTheme
                                                                      .of(context)
                                                                  .bodyMedium
