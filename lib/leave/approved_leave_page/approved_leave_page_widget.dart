            ...
            child: Column(
              ...
              children: [
                ...
                Expanded(
                  child: Builder(
                    builder: (context) {
                      final listApproveData = List.generate(
                                                                          ...
                                                                          children: [
                                                                            Padding(
                                                                              ...
                                                                              child: SelectionArea(
                                                                                  child: Text(
                                                                                FFLocalizations.of(context).getText(
                                                                                  'ksy0ziy9' /* Department affiliation: */,
                                                                                ),
                                                          ...
                                                          children: [
                                                            SelectionArea(
                                                              ...
                                                              FFLocalizations.of(
                                                                      context)
                                                                  .getText(
                                                                'r7v1sy2p' /* Contact telephone number: */,
                                                              ),
                                                              style: FlutterFlowTheme
                                                                      .of(context)
                                                                  .bodyMedium
