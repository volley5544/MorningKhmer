...
class _SuperAppPageWidgetState extends State<SuperAppPageWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      if (!(FFAppState().fromPinPage || FFAppState().fromSetPin)) {
                        ...
                        child: Container(
                          ...
                          child: Container(
                            ...
                            child: CachedNetworkImage(
                              ...
                              imageUrl: 'https://picsum.photos/seed/265/600',
                              fit: BoxFit.cover,
                                                      ...
                                                      children: [
                                                        ...
                                                        Text(
                                                          FFLocalizations.of(
                                                                  context)
                                                              .getText(
                                                            '7bfeez4r' /* โปรโมชั่น การขายพิเศษ */,
                                                          ),
                                                          textAlign:
                                                              TextAlign.start,
                                                          style: FlutterFlowTheme
